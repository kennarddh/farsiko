...
function getComp() {
  ...
  function putar() {
    ...
    putarCom.forEach(function (pilCom) {
        pilCom.firstChild.classList.remove("terpilih")
    })
  ...
  player.forEach(function (pil) {
    ...
    //   info.classList.remove('hasil')
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {
          // Menampilkan Hasil
          info.classList.remove('KALAH')
          info.classList.remove('MENANG')
          info.classList.remove('SERI')
          ...
          switch (hasil) {
              case "KALAH":
                ...
                scoreComElement.innerHTML = "Score : " + scoreCom
                break;
            case "MENANG":
                scorePlayer++

                scorePlayerElement.innerHTML = "Score : " + scorePlayer
                break;
          }
        }, 300)
      }, 2000)
